...
INSERT INTO "new_Ticket" ("assignee", "branchName", "commitSha", "createdAt", "description", "developmentAgent", "developmentNotes", "feasibilityAgent", "feasibilityNotes", "feasibilityResult", "githubIssueNumber", "githubIssueUrl", "id", "labels", "order", "priority", "projectId", "qaNotes", "qaResult", "reporter", "status", "title", "updatedAt") SELECT "assignee", "branchName", "commitSha", "createdAt", "description", "developmentAgent", "developmentNotes", "feasibilityAgent", "feasibilityNotes", "feasibilityResult", "githubIssueNumber", "githubIssueUrl", "id", "labels", "order", "priority", "projectId", "qaNotes", "qaResult", "reporter", "status", "title", "updatedAt" FROM "Ticket";
DROP TABLE "Ticket";
